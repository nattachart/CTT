...
FRAMEWORK_DIR = platform.get_package_dir("framework-waspmote")
FRAMEWORK_VERSION = platform.get_package_version("framework-waspmote")
...
if "build.variant" in env.BoardConfig():
    ...
    libs.append(env.BuildLibrary(
        join("$BUILD_DIR", "FrameworkWaspmoteVariant"),
...
libs.append(envsafe.BuildLibrary(
    join("$BUILD_DIR", "FrameworkWaspmote"),
    join(FRAMEWORK_DIR, "cores", env.BoardConfig().get("build.core"))
))
